...
pub mod report;
use crate::graph::callgraph::{CallGraph, InstanceId};
use crate::analysis::controldep;
use crate::analysis::datadep;
use crate::analysis::defuse;
use crate::analysis::pointsto_inter::{Andersen, AliasId, ApproximateAliasKind};
use crate::detector::report::{Report, ReportContent};
use crate::concurrency::atomic::AtomicApi;
...
fn atomic_uses_influences<'tcx>(
    ...
    let alias_kind = alias_analysis.alias(influencer_id, influencee_id,param_env);
