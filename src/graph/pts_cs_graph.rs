...
use crate::analysis::pointstocs::ApproximateAliasKind;
...
impl<'tcx> PtsDetecterCS<'tcx> {
    ...
    pub fn output_pts<'a>(
        ...
        let mut file = std::fs::File::create("pts_cs_map.dot").unwrap();
